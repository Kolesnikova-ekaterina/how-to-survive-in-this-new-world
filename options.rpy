...
define config.name = _("Как выжить в этои новом мире")
...
define gui.about = _p("""
Как выжить в этом новом мире - игра в жанре визуальная новелла, рассказывающая

историю об обычном школьнике, попавшем в странный, незнакомый мир, полный

тайн и загадок, герою предстоит узнать историю этого места и столкнуться

с головоломками по пути домой.""")
...
define build.name = "howtosurviveinthisnewworld"
...
define config.main_menu_music = "audio/how to survive in this new world gameplay theme.ogg"
...
define config.save_directory = "howtosurviveinthisnewworld-1637166395"
